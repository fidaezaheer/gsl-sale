odoo.define('product_gs.placement_report', function (require) {
    'use strict';
    ...
    var placement_report = AbstractAction.extend({
        ...
        init: function (parent, action) {
            ...
            this.given_context.selected = action.context.selected || false;
        },
        ...
        set_html: function () {
            ...
            return def.then(function () {
                ...
                self.report_widget.$el.find('.o_report_heading').html('<h1>Placement Report</h1>');
            });
        },
        ...
        //         var data = {'phase_id': self.given_context.active_id, 'type': 'placement'};
        //         session.get_file({
    ...
    core.action_registry.add("placement_report", placement_report);
